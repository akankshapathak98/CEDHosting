...
$data=$product_category->getParent();
?>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            <h4 class="mb-0 text-sm"><?php echo (isset($_SESSION['admin']))?$_SESSION['admin']['name']:'';?></h4>
                          </div>
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span class="avatar avatar-sm rounded-circle">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold"><?php echo (isset($_SESSION['admin']))?$_SESSION['admin']['name']:'';?></span>
                  </div>
                </div>
              </a>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    $html='<input class="form-control" disabled type="Text" value="'.$row['prod_name'].'">';
                    }
                    echo $html;
                    ?>
                  </div>
                ...
                <div class="text-center">
                  <button type="button" id="createcategory" class="btn btn-primary mt-4">Create Category</button>
                </div>
              </form>
            </div>
          </div>
