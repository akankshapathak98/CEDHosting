        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Create New Product</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  aria-current="page">Create New Product </li>
                </ol>
              </nav>
            </div>
             ...
             <select class="custom-select" id="inputGroupSelect01">
               <option selected>Please Select</option>
                ...
                while ($row = mysqli_fetch_array($data)) {
                    $html.='<option 
                   value="'.$row['prod_name'].'">'.$row['prod_name'].'</option>';
                }
                   echo $html;
                ?>
             </select>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        placeholder=" This would be Monthly Plan "  type="number">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <span class='requirefield'>*</span>
                        <input type="number" id="input-city" 
                        class="form-control" 
                        placeholder="This would be Annual Price " value="New York">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        class="form-control" placeholder="SKU" value="United States">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <span class='requirefield'>*</span>
                        <input  class="form-control" 
                        placeholder=" Enter 0.5 for 512 MB "  type="number">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-city" 
                        class="form-control" 
                        placeholder="Separate by (,) Ex:
                         PHP, MySQL, MongoDB " value="New York">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        will be provided, enter 0 if none  "  type="number">
                      </div>
                    </div>
                  </div>
